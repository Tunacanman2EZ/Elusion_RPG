...
That serves four endpoints — POST /api/auth/register, POST /api/auth/login, GET /api/auth/session, POST /api/auth/logout — and interactive Swagger docs (via flasgger) at http://127.0.0.1:5000/apidocs.
...
Art, graphics and audio are not covered by that license. See assetlicense.md. If you'd like to contribute assets, read docs/ASSET_CONTRIBUTOR_AGREEMENT.md first.
